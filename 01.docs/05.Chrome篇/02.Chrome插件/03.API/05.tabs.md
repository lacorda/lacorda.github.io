...
chrome.tabs.onUpdated.addListener(
  callback: (tabId: number, changeInfo: {status?: TabStatus, url?: string, pinned?: boolean, audible?: boolean, discarded?: boolean, autoDiscardable?: boolean, mutedInfo?: MutedInfo, favIconUrl?: string, title?: string}, tab: Tab) => void,
)
```
...
chrome.tabs.onMoved.addListener(
  callback: (tabId: number, moveInfo: {fromIndex: number, toIndex: number, windowId: number}, tab: Tab) => void,
)
```
